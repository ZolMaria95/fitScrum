import {i}from'./chunk-BWOZa0Ch.js';import {Q as Qt}from'./chunk-_YHoSp2L.js';import {D,B as Bn,u as ue$1,W as Wt,P as Pe$1,g as De$1,l as lD,M as Mo,i as UL,Y as YL,j as Oy,k as Wt$1,H,x as xE,m as ur,N as Nt,p as bo,s as si,o as oi$1,h as hp,q as qI,a as Dc,t as tI,r as cp,c as xy,d as ap,n as nI,I as Ip,v as DI,w as b,Q as Qh,y as M,z as kE,A as bl,C as qr,E as hr,F as w$1,X as Xn,G as mI,J as yI,K as RI,L as Cp,S as yp,T as EI,V as II,$ as Or,a0 as hh,a1 as h,a2 as Dm,a3 as Jf,a4 as tD,a5 as Bl,a6 as Ed,a7 as sp,a8 as vp,a9 as PE,aa as Xt,ab as Tp,ac as ep,ad as fI,ae as Yl,e as hI,af as Kl,f as xp,ag as S,ah as Me$1,ai as ct,aj as B,ak as q,al as nh,am as cn,an as je$1,ao as ge$1,ap as kh,aq as Br,ar as Ir,as as Lv,at as kr,au as ee,av as Be$1,aw as Ri,ax as GL,ay as Hr,az as Xt$1,aA as Ss,aB as qo,aC as zh,aD as Lh,aE as Fh,aF as dp}from'./main-JGKO53DR.js';import {y as yi,v as vi,I as It,X as Xe$1,H as H$1}from'./chunk-Cr9YZxDd.js';import {v as va,A as An}from'./chunk-CdW9Akkk.js';import {w}from'./chunk-DBEd5vFA.js';function de(i){i||(i=D(Pe$1));let c=new M(t=>{if(i.destroyed){t.next();return}return i.onDestroy(t.next.bind(t))});return t=>t.pipe(Qh(c))}function me(i,c){let e=!c?.manualCleanup?c?.injector?.get(Pe$1)??D(Pe$1):null,n=Me(c?.equal),r;c?.requireSync?r=Mo({kind:0},{equal:n}):r=Mo({kind:1,value:c?.initialValue},{equal:n});let o,V=i.subscribe({next:h=>r.set({kind:1,value:h}),error:h=>{r.set({kind:2,error:h}),o?.();},complete:()=>{o?.();}});if(c?.requireSync&&r().kind===0)throw new b(601,false);return o=e?.onDestroy(V.unsubscribe.bind(V)),lD(()=>{let h=r();switch(h.kind){case 1:return h.value;case 2:throw h.error;case 0:throw new b(601,false)}},{equal:c?.equal})}function Me(i=Object.is){return (c,t)=>c.kind===1&&t.kind===1&&i(c.value,t.value)}var he=(()=>{class i{static \u0275fac=function(e){return new(e||i)};static \u0275mod=kE({type:i});static \u0275inj=bl({imports:[qr]})}return i})();var De=["*"],Se=`.mdc-list {
  margin: 0;
  padding: 8px 0;
