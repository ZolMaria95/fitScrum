import {E as E$1,B as Bn,y as yn,s as sD,aF as lh,k as kE,aG as J,i as ii,U as UI,D as Dc,m as mp,aH as oI,e as eI,o as up,R as Ry,l as lp,aI as iI,t as tI,aJ as W,q,ac as dI,L as Lp,ad as Zl,z as zI,ae as Yl,a as Uv,aK as DI,b as kp,P as Pp,W as Wv,A as yc,C as io,G as pr,aw as WL,aA as ND,af as M,at as X,aL as nn$1,au as he,an as ge$1,X as Xc,K as Kh,aM as st,a9 as Xt,ao as Fh,a8 as Yf,aN as zL,a3 as Bp,a6 as Ec,S as _p,ag as Ne,aO as Ii$1,aP as kn,x as N$2,w as we,ay as Fy,aQ as L,az as tn$1,aR as Xh,aS as cl,aT as sm,aU as QL,$ as th,F as oF,ax as Vr,T as Ep,V as vI,Y as EI,aq as Mr$1,ah as at$2,aj as q$1,ak as ql,aV as Gp,aW as Yl$1,aX as p,J as gI,M as mI,a7 as Ip,aY as m,aZ as cu,a_ as lu,a$ as oo,b0 as hp,Q as kI,_ as _c,p as pI,b1 as rI,b2 as Bt$1,O as Ot$2,b3 as lr,ar as Vv,b4 as Rp,ai as B,b5 as Lh,b6 as Zt,b7 as O,b8 as Ne$1,b9 as Oe$1,aa as bp,ba as Dh,bb as jp,bc as QI,bd as ZI}from'./main-5Y3P2Y7M.js';import {_,I}from'./chunk-Bt7VeHAF.js';import {x as xa,L as Li$1,A as Aa,B as Bi$1,I as Ia,D as Da,E as Ea,P as Pi$1,R as Ri$1,a as at$1,O as Oi$1,N as Ni$1,b as ae,F as Fi$1,Q as Qi$1,V as Vi,M as Ma,c as Mi$1,n as nt,u as ua,d as xi$1}from'./chunk-DtzOHOag.js';import {F as Ft$1,R as Rt$1,r}from'./chunk-C_DF4Qa1.js';import {U as Ue,I as Ia$1,x as xa$1,M as Mr,w as wr,J as Ja,Q as Qn}from'./chunk-DRL4xj1y.js';import {v as vt,G as Gi,O as Oe,N as N$1,u as ue,_ as _i$1,m as mi$1,p as pi$1,f as fi$1,a as ui$1}from'./chunk-C6_hM0cT.js';import {d as de,i as it,o as oe,O as Ot$1,n as nn,t as tn}from'./chunk-FNI2UDRQ.js';import {Q as Qt}from'./chunk-DslhvKDK.js';import {b as be,E as Ei$1,O as Oi$2,T as Tt$1,J as J$1,U}from'./chunk-DpzxBhUD.js';import {v as va,g as ga,A as An,t as ta$1,i as ie,a as gn,X as Xn,Z as Ze,b as bn,h as ht,S}from'./chunk-Cqs_j9Jc.js';function St(o){let n=o.cloneNode(true),e=n.querySelectorAll("[id]"),t=o.nodeName.toLowerCase();n.removeAttribute("id");for(let i=0;i<e.length;i++)e[i].removeAttribute("id");return t==="canvas"?ci(o,n):(t==="input"||t==="select"||t==="textarea")&&si(o,n),ri("canvas",o,n,ci),ri("input, textarea, select",o,n,si),n}function ri(o,n,e,t){let i=n.querySelectorAll(o);if(i.length){let a=e.querySelectorAll(o);for(let r=0;r<i.length;r++)t(i[r],a[r]);}}var Hi=0;function si(o,n){n.type!=="file"&&(n.value=o.value),n.type==="radio"&&n.name&&(n.name=`mat-clone-${n.name}-${Hi++}`);}function ci(o,n){let e=n.getContext("2d");if(e)try{e.drawImage(o,0,0);}catch{}}function Mt(o){let n=o.getBoundingClientRect();return {top:n.top,right:n.right,bottom:n.bottom,left:n.left,width:n.width,height:n.height,x:n.x,y:n.y}}function wt(o,n,e){let{top:t,bottom:i,left:a,right:r}=o;return e>=t&&e<=i&&n>=a&&n<=r}function Ui(o,n){let e=n.left<o.left,t=n.left+n.width>o.right,i=n.top<o.top,a=n.top+n.height>o.bottom;return e||t||i||a}function ke(o,n,e){o.top+=n,o.bottom=o.top+o.height,o.left+=e,o.right=o.left+o.width;}function li(o,n,e,t){let{top:i,right:a,bottom:r,left:s,width:h,height:g}=o,f=h*n,O=g*n;return t>i-O&&t<r+O&&e>s-f&&e<a+f}var ot=class{_document;positions=new Map;constructor(n){this._document=n;}clear(){this.positions.clear();}cache(n){this.clear(),this.positions.set(this._document,{scrollPosition:this.getViewportScrollPosition()}),n.forEach(e=>{this.positions.set(e,{scrollPosition:{top:e.scrollTop,left:e.scrollLeft},clientRect:Mt(e)});});}handleScroll(n){let e=O(n),t=this.positions.get(e);if(!t)return null;let i=t.scrollPosition,a,r;if(e===this._document){let g=this.getViewportScrollPosition();a=g.top,r=g.left;}else a=e.scrollTop,r=e.scrollLeft;let s=i.top-a,h=i.left-r;return this.positions.forEach((g,f)=>{g.clientRect&&e!==f&&e.contains(f)&&ke(g.clientRect,s,h);}),i.top=a,i.left=r,{top:s,left:h}}getViewportScrollPosition(){return {top:window.scrollY,left:window.scrollX}}};function xi(o,n){let e=o.rootNodes;if(e.length===1&&e[0].nodeType===n.ELEMENT_NODE)return e[0];let t=n.createElement("div");return e.forEach(i=>t.appendChild(i)),t}function Rt(o,n,e){for(let t in n)if(n.hasOwnProperty(t)){let i=n[t];i?o.setProperty(t,i,e?.has(t)?"important":""):o.removeProperty(t);}return o}function ge(o,n){let e=n?"":"none";Rt(o.style,{"touch-action":n?"":"none","-webkit-user-drag":n?"":"none","-webkit-tap-highlight-color":n?"":"transparent","user-select":e,"-ms-user-select":e,"-webkit-user-select":e,"-moz-user-select":e});}function di(o,n,e){Rt(o.style,{position:n?"":"fixed",top:n?"":"0",opacity:n?"":"0",left:n?"":"-999em"},e);}function at(o,n){return n&&n!="none"?o+" "+n:o}function hi(o,n){o.style.width=`${n.width}px`,o.style.height=`${n.height}px`,o.style.transform=xe(n.left,n.top);}function xe(o,n){return `translate3d(${Math.round(o)}px, ${Math.round(n)}px, 0)`}var fe={capture:true},yt={passive:false,capture:true},Wi=(()=>{class o{static \u0275fac=function(t){return new(t||o)};static \u0275cmp=kE({type:o,selectors:[["ng-component"]],hostAttrs:["cdk-drag-resets-container",""],decls:0,vars:0,template:function(t,i){},styles:[`@layer cdk-resets {
  .cdk-drag-preview {
    background: none;
    border: none;
    padding: 0;
...
`],encapsulation:2})}return o})(),Li=(()=>{class o{static \u0275fac=function(t){return new(t||o)};static \u0275mod=yc({type:o});static \u0275inj=io({imports:[Lt,oF]})}return o})();function So(o,n){if(o&1&&(ii(0,"mat-option",16),UI(1),Dc()),o&2){let e=n.$implicit;lp("value",e),Ry(),kp(e);}}function wo(o,n){if(o&1){let e=dI();ii(0,"mat-form-field",8)(1,"mat-label"),UI(2,"Estado"),Dc(),ii(3,"mat-select",15),Lp("ngModelChange",function(i){Zl(e);let a=pI();return zI(a.status,i)||(a.status=i),Yl(i)}),oI(4,So,2,2,"mat-option",16,rI),Dc(),Uv(),Dc();}if(o&2){let e=pI();Ry(3),Pp("ngModel",e.status),Wv(),Ry(),iI(e.STATUSES);}}function Do(o,n){if(o&1){let e=dI();ii(0,"button",17),mp("click",function(){Zl(e);let i=pI();return Yl(i.remove())}),UI(1,"Borrar"),Dc(),up(2,"span",18);}if(o&2){let e=pI();lp("disabled",e.esUnico)("matTooltip",e.esUnico?"No se puede borrar el \xFAnico sprint":"");}}var ye=class o{data=E$1(be);dialog=E$1(vt);snack=E$1(Qt);ref=E$1(N$1);input=E$1(ue);sprint=this.input.sprint;isNew=!this.sprint;STATUSES=["active","completed","planned"];esUnico=this.data.getSprints().sprints.length<=1;name=this.sprint?.name??"";goal=this.sprint?.goal??"";capacity=this.sprint?.capacity??0;status=this.sprint?.status??"active";startModel=this.sprint?.start?new Date(this.sprint.start+"T00:00:00"):null;endModel=this.sprint?.end?new Date(this.sprint.end+"T00:00:00"):null;toIso(n){if(!n)return "";let e=t=>String(t).padStart(2,"0");return `${n.getFullYear()}-${e(n.getMonth()+1)}-${e(n.getDate())}`}save(){let n=this.name.trim();if(!n){this.snack.open("El nombre del sprint no puede quedar vac\xEDo.","OK",{duration:3e3});return}let e={name:n,goal:this.goal.trim(),start:this.toIso(this.startModel),end:this.toIso(this.endModel),capacity:Number(this.capacity)||0};this.isNew?(this.data.addSprint(e),this.snack.open("Sprint creado. El anterior se cerr\xF3 y las tareas no aprobadas migraron.","OK",{duration:4e3})):this.data.updateSprint(this.sprint.id,W(q({},e),{status:this.status})),this.ref.close(true);}async remove(){if(!this.sprint||this.esUnico)return;await lh(this.dialog.open(ae,{data:{title:"Borrar sprint",message:`Vas a borrar "${this.sprint.name}".

Las tareas del sprint NO se eliminan.`,confirmText:"Borrar",danger:true}}).afterClosed())&&(this.data.deleteSprint(this.sprint.id),this.ref.close(true));}static \u0275fac=function(e){return new(e||o)};static \u0275cmp=kE({type:o,selectors:[["app-sprint-dialog"]],decls:38,vars:13,consts:[["startP",""],["endP",""],["mat-dialog-title",""],[1,"sprint-form"],["appearance","outline",1,"full"],["matInput","","placeholder","Sprint 3",3,"ngModelChange","ngModel"],["matInput","","rows","2","placeholder","Objetivo del sprint",3,"ngModelChange","ngModel"],[1,"row"],["appearance","outline",1,"grow"],["matInput","",3,"ngModelChange","matDatepicker","ngModel"],["matIconSuffix","",3,"for"],["matInput","","type","number","min","0",3,"ngModelChange","ngModel"],["align","end"],["mat-button","","mat-dialog-close",""],["mat-flat-button","","color","primary",3,"click"],[3,"ngModelChange","ngModel"],[3,"value"],["mat-button","",1,"danger",3,"click","disabled","matTooltip"],[1,"spacer"]],template:function(e,t){if(e&1){let i=dI();ii(0,"h2",2),UI(1),Dc(),ii(2,"mat-dialog-content",3)(3,"mat-form-field",4)(4,"mat-label"),UI(5,"Nombre"),Dc(),ii(6,"input",5),Lp("ngModelChange",function(r){return Zl(i),zI(t.name,r)||(t.name=r),Yl(r)}),Dc(),Uv(),Dc(),ii(7,"mat-form-field",4)(8,"mat-label"),UI(9,"Objetivo"),Dc(),ii(10,"textarea",6),Lp("ngModelChange",function(r){return Zl(i),zI(t.goal,r)||(t.goal=r),Yl(r)}),Dc(),Uv(),Dc(),ii(11,"div",7)(12,"mat-form-field",8)(13,"mat-label"),UI(14,"Inicio"),Dc(),ii(15,"input",9),Lp("ngModelChange",function(r){return Zl(i),zI(t.startModel,r)||(t.startModel=r),Yl(r)}),Dc(),Uv(),up(16,"mat-datepicker-toggle",10)(17,"mat-datepicker",null,0),Dc(),ii(19,"mat-form-field",8)(20,"mat-label"),UI(21,"Fin"),Dc(),ii(22,"input",9),Lp("ngModelChange",function(r){return Zl(i),zI(t.endModel,r)||(t.endModel=r),Yl(r)}),Dc(),Uv(),up(23,"mat-datepicker-toggle",10)(24,"mat-datepicker",null,1),Dc()(),ii(26,"div",7)(27,"mat-form-field",8)(28,"mat-label"),UI(29,"Capacidad (pts)"),Dc(),ii(30,"input",11),Lp("ngModelChange",function(r){return Zl(i),zI(t.capacity,r)||(t.capacity=r),Yl(r)}),Dc(),Uv(),Dc(),eI(31,wo,6,1,"mat-form-field",8),Dc()(),ii(32,"mat-dialog-actions",12),eI(33,Do,3,2),ii(34,"button",13),UI(35,"Cancelar"),Dc(),ii(36,"button",14),mp("click",function(){return t.save()}),UI(37),Dc()();}if(e&2){let i=DI(18),a=DI(25);Ry(),kp(t.isNew?"Nuevo sprint":"Editar "+t.sprint.id),Ry(5),Pp("ngModel",t.name),Wv(),Ry(4),Pp("ngModel",t.goal),Wv(),Ry(5),lp("matDatepicker",i),Pp("ngModel",t.startModel),Wv(),Ry(),lp("for",i),Ry(6),lp("matDatepicker",a),Pp("ngModel",t.endModel),Wv(),Ry(),lp("for",a),Ry(7),Pp("ngModel",t.capacity),Wv(),Ry(),tI(t.isNew?-1:31),Ry(2),tI(t.isNew?-1:33),Ry(4),kp(t.isNew?"Crear":"Guardar");}},dependencies:[ta$1,ie,gn,Xn,Ze,bn,_i$1,mi$1,pi$1,fi$1,ui$1,va,ga,de,it,oe,Ot$1,nn,tn,Ft$1,Rt$1,J,Mr,wr,Ja,Qn,Gi,Oe],styles:[".sprint-form[_ngcontent-%COMP%]{display:flex;flex-direction:column;padding-top:8px;min-width:420px}.full[_ngcontent-%COMP%]{width:100%}.row[_ngcontent-%COMP%]{display:flex;gap:12px}.row[_ngcontent-%COMP%]   .grow[_ngcontent-%COMP%], .spacer[_ngcontent-%COMP%]{flex:1}.danger[_ngcontent-%COMP%]{color:var(--mat-sys-error)}@media(max-width:520px){.sprint-form[_ngcontent-%COMP%]{min-width:0}.row[_ngcontent-%COMP%]{flex-direction:column;gap:0}}"]})};var dt=(o,n)=>n.id,Po=(o,n)=>n.status;function To(o,n){if(o&1&&(ii(0,"mat-option",3),UI(1),Dc()),o&2){let e=n.$implicit;lp("value",e.id),Ry(),Rp("",e.name,"",e.status==="completed"?" \u2713":"");}}function Eo(o,n){if(o&1&&(ii(0,"span",20),UI(1),Dc()),o&2){let e=pI();Ry(),_c("\u2014 ",e.goal);}}function Io(o,n){if(o&1&&(ii(0,"span",24),UI(1),Dc(),ii(2,"span",21),UI(3,"\xB7"),Dc()),o&2){let e=pI(),t=pI();Ry(),Rp("",t.fmtSprintDate(e.start)," \u2192 ",t.fmtSprintDate(e.end));}}function Mo(o,n){if(o&1&&(ii(0,"div",6)(1,"span",19),UI(2),Dc(),eI(3,Eo,2,1,"span",20),ii(4,"span",21),UI(5,"\xB7"),Dc(),eI(6,Io,4,2),ii(7,"span",22),UI(8),Dc(),ii(9,"span",23),UI(10),Dc()()),o&2){let e=n;Ry(2),kp(e.name),Ry(),tI(e.goal?3:-1),Ry(3),tI(e.start||e.end?6:-1),Ry(2),_c("",e.capacity," pts"),Ry(),kI("st-"+e.status),Ry(),kp(e.status);}}function Ro(o,n){if(o&1&&(ii(0,"mat-button-toggle",3),UI(1),Dc()),o&2){let e=n.$implicit,t=pI();lp("value",e),Ry(),kp(e==="all"?"Todas":t.PRIORITY_LABELS[e]);}}function Oo(o,n){if(o&1&&(ii(0,"mat-option",3),UI(1),Dc()),o&2){let e=n.$implicit;lp("value",e.id),Ry(),kp(e.name);}}function Ao(o,n){o&1&&(ii(0,"mat-option",32),UI(1,"Sin coincidencias"),Dc());}function Bo(o,n){if(o&1){let e=dI();ii(0,"mat-chip",35),mp("removed",function(){let i=Zl(e).$implicit,a=pI(3);return Yl(a.removeAssignee(i))}),UI(1),ii(2,"button",36)(3,"mat-icon"),UI(4,"close"),Dc()()();}if(o&2){let e=n.$implicit,t=pI(3),i=t.resolveMember(e);bp("background",t.pastel(i?.color||"#9aa0a6")),lp("matTooltip",i?.name||e),Ry(),_c(" ",t.shortName(i?.name||e)," "),Ry(),Ec("aria-label","Quitar "+(i?.name||e));}}function Fo(o,n){if(o&1&&(ii(0,"mat-chip-set",33),oI(1,Bo,5,5,"mat-chip",34,rI),Dc()),o&2){let e=pI(2);Ry(),iI(e.selectedAssignees());}}function Lo(o,n){if(o&1){let e=dI();ii(0,"div",9)(1,"span",25),UI(2,"Asignado a:"),Dc(),ii(3,"mat-form-field",26)(4,"mat-label"),UI(5,"Consultores"),Dc(),ii(6,"mat-select",27),mp("selectionChange",function(i){Zl(e);let a=pI();return Yl(a.onAssigneeSelectChange(i.value))})("closed",function(){Zl(e);let i=pI();return Yl(i.buscarAsignado.set(""))}),ii(7,"div",28),mp("click",function(i){return i.stopPropagation()}),ii(8,"div",29)(9,"mat-icon"),UI(10,"search"),Dc(),ii(11,"input",30),mp("input",function(i){Zl(e);let a=pI();return Yl(a.buscarAsignado.set(i.target.value))})("keydown",function(i){return i.stopPropagation()}),Dc()(),ii(12,"button",31),mp("click",function(i){return Zl(e),pI().toggleAllAssignees(),Yl(i.stopPropagation())}),UI(13),Dc()(),oI(14,Oo,2,2,"mat-option",3,dt,false,Ao,2,0,"mat-option",32),Dc()(),eI(17,Fo,3,0,"mat-chip-set",33),Dc();}if(o&2){let e=pI();Ry(6),lp("value",e.selectedAssignees()),Ry(5),lp("value",e.buscarAsignado()),Ry(2),_c(" ",e.allAssigneesSelected()?"Quitar todos":"Seleccionar todos"," "),Ry(),iI(e.assigneeOptions()),Ry(3),tI(e.selectedAssignees().length?17:-1);}}function No(o,n){if(o&1&&(ii(0,"mat-option",3),UI(1),Dc()),o&2){let e=n.$implicit;lp("value",e.id),Ry(),kp(e.name);}}function Vo(o,n){o&1&&(ii(0,"mat-option",32),UI(1,"Sin coincidencias"),Dc());}function zo(o,n){if(o&1){let e=dI();ii(0,"mat-chip",40),mp("removed",function(){let i=Zl(e).$implicit,a=pI(3);return Yl(a.removeClient(i))}),UI(1),ii(2,"button",36)(3,"mat-icon"),UI(4,"close"),Dc()()();}if(o&2){let e=n.$implicit,t=pI(3);bp("background",t.pastel(t.clientColorOf(e))),lp("matTooltip",t.clientNameOf(e)),Ry(),_c(" ",t.clientNameOf(e)," "),Ry(),Ec("aria-label","Quitar "+t.clientNameOf(e));}}function Go(o,n){if(o&1&&(ii(0,"mat-chip-set",33),oI(1,zo,5,5,"mat-chip",39,rI),Dc()),o&2){let e=pI(2);Ry(),iI(e.selectedClients());}}function Ho(o,n){if(o&1){let e=dI();ii(0,"div",10)(1,"span",25),UI(2,"Cliente:"),Dc(),ii(3,"mat-form-field",37)(4,"mat-label"),UI(5,"Clientes"),Dc(),ii(6,"mat-select",27),mp("selectionChange",function(i){Zl(e);let a=pI();return Yl(a.onClientSelectChange(i.value))})("closed",function(){Zl(e);let i=pI();return Yl(i.buscarCliente.set(""))}),ii(7,"div",28),mp("click",function(i){return i.stopPropagation()}),ii(8,"div",29)(9,"mat-icon"),UI(10,"search"),Dc(),ii(11,"input",38),mp("input",function(i){Zl(e);let a=pI();return Yl(a.buscarCliente.set(i.target.value))})("keydown",function(i){return i.stopPropagation()}),Dc()(),ii(12,"button",31),mp("click",function(i){return Zl(e),pI().toggleAllClients(),Yl(i.stopPropagation())}),UI(13),Dc()(),oI(14,No,2,2,"mat-option",3,dt,false,Vo,2,0,"mat-option",32),Dc()(),eI(17,Go,3,0,"mat-chip-set",33),Dc();}if(o&2){let e=pI();Ry(6),lp("value",e.selectedClients()),Ry(5),lp("value",e.buscarCliente()),Ry(2),_c(" ",e.allClientsSelected()?"Quitar todos":"Seleccionar todos"," "),Ry(),iI(e.clientOptions()),Ry(3),tI(e.selectedClients().length?17:-1);}}function Uo(o,n){if(o&1){let e=dI();ii(0,"button",41),mp("click",function(){Zl(e);let i=pI();return Yl(i.clearBoard())}),ii(1,"mat-icon"),UI(2,"delete_sweep"),Dc(),UI(3," Borrar Board "),Dc();}}function Wo(o,n){if(o&1){let e=dI();ii(0,"button",64),mp("click",function(i){Zl(e);let a=pI().$implicit,r=pI(2);return i.stopPropagation(),Yl(r.deleteCard(a))}),ii(1,"mat-icon"),UI(2,"close"),Dc()();}}function $o(o,n){if(o&1&&(ii(0,"span",55),UI(1),Dc()),o&2){pI();let e=ZI(1);Ry(),kp(e.name);}}function qo(o,n){if(o&1&&(ii(0,"span",57),UI(1),Dc()),o&2){let e=pI().$implicit;Ry(),kp(e.hdEstatus);}}function jo(o,n){if(o&1&&(ii(0,"div",58),UI(1),Dc()),o&2){pI();let e=ZI(2);Ry(),_c("\u26A0 Pr\xF3ximo a vencer \u2014 ",e.badge);}}function Zo(o,n){if(o&1){let e=dI();ii(0,"div",65),mp("click",function(i){return i.stopPropagation()}),up(1,"mat-progress-bar",66),ii(2,"input",67),mp("change",function(i){Zl(e);let a=pI().$implicit,r=pI(2);return Yl(r.onProgressChange(a,i.target.value))}),Dc()(),ii(3,"button",68),mp("click",function(i){Zl(e);let a=pI().$implicit,r=pI(2);return i.stopPropagation(),Yl(r.toggleWaiting(a))}),UI(4),Dc();}if(o&2){let e=pI().$implicit,t=pI(2);Ry(),bp("--mdc-linear-progress-active-indicator-color",t.progColor(e.progress)),lp("value",e.progress),Ry(),lp("value",e.progress);let i=t.waitingDays(e);Ry(),_p("active",i!==null&&i<3)("alert",i!==null&&i>=3),Ry(),_c(" ",i!==null&&i>=3?"\u26A0 Notificar al cliente":"\u23F3 Esperando cliente"," ");}}function Ko(o,n){if(o&1){let e=dI();ii(0,"div",69),mp("click",function(i){return i.stopPropagation()}),ii(1,"mat-checkbox",70),mp("change",function(i){Zl(e);let a=pI().$implicit,r=pI(2);return Yl(r.onCert(a,i))}),Dc(),ii(2,"span",71),UI(3,"Certificado"),Dc()();}o&2&&(Ry(),lp("checked",false));}function Qo(o,n){if(o&1){let e=dI();ii(0,"div",69),mp("click",function(i){return i.stopPropagation()}),ii(1,"mat-checkbox",72),mp("change",function(i){Zl(e);let a=pI().$implicit,r=pI(2);return Yl(r.onFinalize(a,i))}),UI(2),Dc()();}if(o&2){let e=pI().$implicit;Ry(),lp("checked",e.approved)("disabled",!!e.ticket),Ry(),_c(" ",e.approved?"Finalizado \u2713":"Finalizado"," ");}}function Yo(o,n){if(o&1&&(ii(0,"span",73),UI(1),Dc()),o&2){pI();let e=ZI(0);bp("background",e.color),lp("matTooltip",e.name),Ry(),kp(e.id);}}function Xo(o,n){o&1&&up(0,"span",63);}function Jo(o,n){if(o&1){let e=dI();jp(0)(1)(2),ii(3,"mat-card",49),mp("click",function(){let i=Zl(e).$implicit,a=pI(2);return Yl(a.openDetail(i))}),ii(4,"div",50)(5,"span",51),UI(6),Dc(),ii(7,"span",52),UI(8),Dc(),up(9,"span",53),eI(10,Wo,3,0,"button",54),Dc(),eI(11,$o,2,1,"span",55),ii(12,"div",56),UI(13),Dc(),eI(14,qo,2,1,"span",57),eI(15,jo,2,1,"div",58),eI(16,Zo,5,9)(17,Ko,4,1,"div",59)(18,Qo,3,3,"div",59),ii(19,"div",60)(20,"span",61)(21,"mat-icon"),UI(22,"event"),Dc(),UI(23),Dc(),eI(24,Yo,2,4,"span",62)(25,Xo,1,0,"span",63),Dc()();}if(o&2){let e,t=n.$implicit,i=pI(2),a=QI(i.resolveMember(t.assignee));Ry();let r=QI(i.clientOf(t.client)),s=i.clientStyle(r);Ry();let h=QI(i.dueInfo(t.dueDate,t.status));Ry(),bp("background",s.bg)("color",s.ink)("--accent",s.accent)("--tilt",i.cardTilt(t.id)),_p("not-mine",!i.canDrag(t))("overdue",h.overdue)("soon",h.soon),lp("cdkDragData",t),Ry(3),_c("#",t.ticket||"\u2014"),Ry(),kI("prio-"+t.priority),Ry(),kp(i.PRIORITY_LABELS[t.priority]),Ry(2),tI(i.puedeGestionarTodo()?10:-1),Ry(),tI(r?11:-1),Ry(2),kp(t.title),Ry(),tI(t.ticket&&t.hdEstatus?14:-1),Ry(),tI(h.soon?15:-1),Ry(),tI((e=t.status)==="in_progress"?16:e==="review"?17:e==="done"?18:-1),Ry(4),_p("overdue",h.overdue)("soon",h.soon),Ry(3),_c("",h.str||"\u2014"," "),Ry(),tI(a?24:25);}}function ea(o,n){o&1&&(ii(0,"div",48)(1,"span"),UI(2,"\u25CB"),Dc(),ii(3,"span"),UI(4,"Sin tareas"),Dc()());}function ta(o,n){if(o&1){let e=dI();ii(0,"section",18)(1,"header",42),up(2,"span",43),ii(3,"span",44),UI(4),Dc(),ii(5,"span",45),UI(6),Dc()(),ii(7,"div",46),mp("cdkDropListDropped",function(i){let a=Zl(e).$implicit,r=pI();return Yl(r.drop(i,a.status))}),oI(8,Jo,26,34,"mat-card",47,dt,false,ea,5,0,"div",48),Dc()();}if(o&2){let e=n.$implicit;Ry(),kI("head-"+e.status),Ry(),kI("dot-"+e.status),Ry(2),kp(e.label),Ry(2),kp(e.cards.length),Ry(),lp("cdkDropListData",e.cards),Ry(),iI(e.cards);}}var Ni=class o{data=E$1(be);auth=E$1(Bn);helpdesk=E$1(Ue);dialog=E$1(vt);snack=E$1(Qt);syncing=yn(false);constructor(){this.helpdesk.getHdUsers(),this.helpdesk.getClients(),this.helpdesk.getTicketStatuses(),this.data.ensureInit().then(()=>this.syncTicketStatuses());}async syncTicketStatuses(){let n=this.data.sprints().active,e=this.data.getStoriesBySprint(n).filter(t=>t.ticket);e.length&&(this.syncing.set(true),await Promise.all(e.map(async t=>{let i=await this.helpdesk.fetchTicketRaw(t.ticket);if(!i)return;let a=String(i.client_id??"").trim();a&&t.client!==a&&this.data.updateStoryClient(t.id,a);let r=String(i.assigned_user_id||"").trim().toUpperCase(),s=String(t.assignee||"").trim().toUpperCase();s&&s!==r&&this.helpdesk.assignTicket(t.ticket,s);let h=String(i.estado||"");h&&t.hdEstatus!==h&&this.data.updateStoryHdEstatus(t.id,h);let g=xa(h);t.status!==g.status&&this.data.updateStoryStatus(t.id,g.status),g.approved!==void 0&&!!t.approved!==g.approved&&(g.approved?this.data.approveStory(t.id):this.data.unapproveStory(t.id)),g.waiting&&!t.waitingClient&&this.data.setWaitingClient(t.id,true);})),this.syncing.set(false));}resolveMember=n=>Li$1(n,this.data.team(),this.helpdesk.hdUsers());dueInfo=Aa;progColor=Bi$1;clientStyle=Ia;pastel=Da;cardTilt=Ea;STATUS_LABELS=Pi$1;PRIORITY_LABELS=Ri$1;PRIORITY_FILTERS=["all","alta","media","baja"];priorityFilter=yn("all");activeClients=yn(new Set);activeAssignees=yn(new Set);ticketSearch=yn("");puedeGestionarTodo=this.auth.puedeGestionarTodo;puedeBorrarBoard=this.auth.puedeBorrarBoard;get myId(){return String(this.auth.session()?.id||"").trim().toUpperCase()}sprints=sD(()=>this.data.sprints().sprints);activeSprintId=sD(()=>this.data.sprints().active);activeSprint=sD(()=>this.data.getActiveSprint());setSprint(n){this.data.setActiveSprint(n);}openNewSprint(){this.dialog.open(ye,{data:{sprint:null},width:"480px",maxWidth:"95vw"});}openEditSprint(){let n=this.activeSprint();n&&this.dialog.open(ye,{data:{sprint:n},width:"480px",maxWidth:"95vw"});}fmtSprintDate(n){return n?new Date(n+"T00:00:00").toLocaleDateString("es-ES",{day:"2-digit",month:"short",year:"numeric"}):""}clients=sD(()=>this.data.clients());visibleStories=sD(()=>{let n=this.data.sprints().active,e=new Date;e.setDate(e.getDate()-2);let t=e.toISOString().split("T")[0];return this.data.stories().filter(i=>i.sprint===n).filter(i=>!(i.status==="done"&&i.approved&&(i.approvedDate||"")<t))});assigneeChips=sD(()=>[...new Set(this.visibleStories().map(e=>e.assignee).filter(Boolean))].map(e=>this.resolveMember(e)).filter(e=>!!e).sort((e,t)=>(e.name||e.id).localeCompare(t.name||t.id,"es")));clientChips=sD(()=>[...new Set(this.visibleStories().map(e=>e.client).filter(Boolean))].map(e=>{let t=this.clientOf(e);return {id:e,name:t?.name||e,color:t?.color||at$1(e)}}).sort((e,t)=>e.name.localeCompare(t.name,"es")));buscarAsignado=yn("");buscarCliente=yn("");filtraOpc(n,e){let t=e.trim().toLowerCase();return t?n.filter(i=>i.name.toLowerCase().includes(t)||i.id.toLowerCase().includes(t)):n}assigneeOptions=sD(()=>this.filtraOpc(this.assigneeChips(),this.buscarAsignado()));clientOptions=sD(()=>this.filtraOpc(this.clientChips(),this.buscarCliente()));columns=sD(()=>{let n=this.priorityFilter(),e=this.activeClients(),t=this.activeAssignees(),i=this.ticketSearch().trim(),a=this.visibleStories().filter(r=>!(n!=="all"&&r.priority!==n||e.size>0&&!(r.client&&e.has(r.client))||t.size>0&&!(!r.assignee||t.has(r.assignee))||i&&!(r.ticket&&String(r.ticket).includes(i))));return Oi$1.map(r=>({status:r,label:Pi$1[r],cards:a.filter(s=>s.status===r)}))});get workDeps(){return {data:this.data,auth:this.auth,dialog:this.dialog,snack:this.snack}}setPriority(n){this.priorityFilter.set(n),this.activeAssignees.set(new Set);}selectedAssignees=sD(()=>[...this.activeAssignees()]);onAssigneeSelectChange(n){this.activeAssignees.set(new Set(n));}allAssigneesSelected=sD(()=>this.assigneeChips().length>0&&this.selectedAssignees().length===this.assigneeChips().length);toggleAllAssignees(){this.allAssigneesSelected()?this.activeAssignees.set(new Set):this.activeAssignees.set(new Set(this.assigneeChips().map(n=>n.id)));}shortName(n){let e=String(n||"").trim().split(/\s+/).filter(Boolean);return e.length<=2?e.join(" "):`${e[0]} ${e[2]}`}removeAssignee(n){let e=new Set(this.activeAssignees());e.delete(n),this.activeAssignees.set(e);}clearAssignees(){this.activeAssignees.set(new Set);}selectedClients=sD(()=>[...this.activeClients()]);onClientSelectChange(n){this.activeClients.set(new Set(n));}allClientsSelected=sD(()=>this.clientChips().length>0&&this.selectedClients().length===this.clientChips().length);toggleAllClients(){this.allClientsSelected()?this.activeClients.set(new Set):this.activeClients.set(new Set(this.clientChips().map(n=>n.id)));}removeClient(n){let e=new Set(this.activeClients());e.delete(n),this.activeClients.set(e);}clientNameOf(n){return this.clientChips().find(e=>e.id===n)?.name||n}clientColorOf(n){return this.clientChips().find(e=>e.id===n)?.color||"#9aa0a6"}clientOf(n){if(!n)return;let e=this.data.getClient(n);if(e)return {id:e.id,name:e.name,color:e.color};let t=this.helpdesk.clients().find(i=>i.id===n);return t?{id:t.id,name:t.name}:{id:n,name:n}}puedeOperar(n){if(this.puedeGestionarTodo())return  true;let e=String(n.assignee||"").trim().toUpperCase();return !!e&&e===this.myId}canDrag(n){return this.puedeOperar(n)}avisoSinPermiso(){this.snack.open("No tienes permisos para modificar esta tarea. Solo el asignado, un supervisor o el Helpdesk pueden.","OK",{duration:4e3});}async drop(n,e){let t=n.item.data;if(!(!t||t.status===e)){if(!this.puedeOperar(t)){this.avisoSinPermiso();return}if(e==="todo"){this.snack.open("Una tarea que ya sali\xF3 de To Do no puede volver.","OK",{duration:3e3});return}if(t.status==="todo"&&e==="in_progress"){if(!await Ni$1(t,this.workDeps))return}else if(!await lh(this.dialog.open(ae,{data:{title:"Mover tarea",message:`\xBFMover "${t.title}" a "${Pi$1[e]}"?`,confirmText:"Mover"}}).afterClosed()))return;this.data.updateStoryStatus(t.id,e),this.pushHdEstado(t,Fi$1[e]);}}pushHdEstado(n,e){!n.ticket||!e||this.helpdesk.setTicketStatus(n.ticket,e).then(t=>{t?this.data.updateStoryHdEstatus(n.id,e):this.snack.open(`No se pudo actualizar el estado del ticket #${n.ticket} en el Helpdesk.`,"OK",{duration:4e3});});}openDetail(n){this.dialog.open(Qi$1,{data:{story:n},width:"560px",maxWidth:"95vw"});}openNew(){this.dialog.open(Qi$1,{data:{story:null},width:"560px",maxWidth:"95vw"});}onProgressChange(n,e){this.data.updateStoryProgress(n.id,Vi(parseInt(e,10)||0));}waitingDays(n){return !n.waitingClient||!n.waitingDate?null:Math.floor((Date.now()-new Date(n.waitingDate+"T00:00:00").getTime())/864e5)}toggleWaiting(n){let e=!n.waitingClient;this.data.setWaitingClient(n.id,e),e&&this.pushHdEstado(n,Ma);}async onCert(n,e){if(!e.checked)return;if(!this.puedeOperar(n)){e.source.checked=false,this.avisoSinPermiso();return}if(!await lh(this.dialog.open(ae,{data:{title:"Certificar tarea",message:`\xBFMarcar "${n.title}" como certificada y moverla a Finalizado?`,confirmText:"Certificar"}}).afterClosed())){e.source.checked=false;return}this.data.updateStoryStatus(n.id,"done"),this.pushHdEstado(n,Fi$1.done);}async onFinalize(n,e){if(n.ticket)return;if(!this.puedeOperar(n)){e.source.checked=!!n.approved,this.avisoSinPermiso();return}if(!e.checked){this.data.unapproveStory(n.id);return}if(!await lh(this.dialog.open(ae,{data:{title:"Finalizar tarea",message:`\xBFMarcar "${n.title}" como finalizada?`,confirmText:"Finalizar"}}).afterClosed())){e.source.checked=false;return}this.data.approveStory(n.id);}async deleteCard(n){await lh(this.dialog.open(ae,{data:{title:"Eliminar tarea",message:`Vas a eliminar la tarea:

"${n.title}"

Esta acci\xF3n NO se puede deshacer.`,confirmText:"Eliminar",danger:true,requireWord:"BORRAR"}}).afterClosed())&&this.data.deleteStory(n.id);}async clearBoard(){let n=this.data.sprints().active,e=this.data.getStoriesBySprint(n).map(i=>i.id);if(!e.length){this.snack.open("No hay tareas en el sprint.","OK",{duration:3e3});return}await lh(this.dialog.open(ae,{data:{title:"Borrar board",message:`Vas a eliminar ${e.length} tarea(s) del sprint activo.

Esta acci\xF3n NO se puede deshacer.`,confirmText:"Borrar todo",danger:true,requireWord:"BORRAR"}}).afterClosed())&&e.forEach(i=>this.data.deleteStory(i));}static \u0275fac=function(e){return new(e||o)};static \u0275cmp=kE({type:o,selectors:[["app-board"]],decls:35,vars:8,consts:[[1,"sprint-bar"],["appearance","outline","subscriptSizing","dynamic",1,"sprint-select"],[3,"selectionChange","value"],[3,"value"],["mat-icon-button","","matTooltip","Editar sprint actual",3,"click","disabled"],["mat-icon-button","","matTooltip","Nuevo sprint",3,"click"],[1,"sprint-banner"],[1,"board-toolbar"],["hideSingleSelectionIndicator","","aria-label","Filtrar por prioridad",1,"prio-filter",3,"change","value"],[1,"assignee-filter"],[1,"client-filter"],["appearance","outline","subscriptSizing","dynamic",1,"ticket-search"],["matInput","","inputmode","numeric","placeholder","Buscar ticket\u2026",3,"input","value"],["matSuffix",""],[1,"spacer"],["mat-flat-button","","color","primary",3,"click"],["mat-stroked-button","",1,"danger"],["cdkDropListGroup","",1,"kanban"],[1,"kanban-col"],[1,"sb-name"],[1,"sb-goal"],[1,"sb-sep"],[1,"sb-cap"],[1,"sb-status"],[1,"sb-dates"],[1,"filter-label"],["appearance","outline","subscriptSizing","dynamic",1,"assignee-select"],["multiple","",3,"selectionChange","closed","value"],[1,"sel-head",3,"click"],[1,"sel-head-search"],["placeholder","Buscar consultor\u2026",3,"input","keydown","value"],["type","button",1,"sel-head-all",3,"click"],["disabled",""],[1,"assignee-chips"],[1,"achip",3,"background","matTooltip"],[1,"achip",3,"removed","matTooltip"],["matChipRemove",""],["appearance","outline","subscriptSizing","dynamic",1,"client-select"],["placeholder","Buscar cliente\u2026",3,"input","keydown","value"],[1,"achip","cchip",3,"background","matTooltip"],[1,"achip","cchip",3,"removed","matTooltip"],["mat-stroked-button","",1,"danger",3,"click"],[1,"col-header"],[1,"col-dot"],[1,"col-title"],[1,"col-count"],["cdkDropList","",1,"col-cards",3,"cdkDropListDropped","cdkDropListData"],["cdkDrag","",1,"story-card",3,"not-mine","overdue","soon","background","color","--accent","--tilt","cdkDragData"],[1,"empty-col"],["cdkDrag","",1,"story-card",3,"click","cdkDragData"],[1,"card-top"],[1,"card-ticket"],[1,"prio-badge"],[1,"grow"],["mat-icon-button","","matTooltip","Eliminar tarea",1,"del-btn"],[1,"client-name"],[1,"card-title"],[1,"hd-estatus"],[1,"soon-badge"],[1,"card-check"],[1,"card-bottom"],[1,"card-due"],[1,"avatar",3,"background","matTooltip"],["matTooltip","Sin asignar",1,"avatar","unassigned"],["mat-icon-button","","matTooltip","Eliminar tarea",1,"del-btn",3,"click"],[1,"prog",3,"click"],["mode","determinate",3,"value"],["type","number","min","0","max","100","step","5",3,"change","value"],[1,"wait-btn",3,"click"],[1,"card-check",3,"click"],["aria-label","Certificado",3,"change","checked"],[1,"check-text"],[3,"change","checked","disabled"],[1,"avatar",3,"matTooltip"]],template:function(e,t){if(e&1&&(ii(0,"div",0)(1,"mat-form-field",1)(2,"mat-label"),UI(3,"Sprint"),Dc(),ii(4,"mat-select",2),mp("selectionChange",function(a){return t.setSprint(a.value)}),oI(5,To,2,3,"mat-option",3,dt),Dc()(),ii(7,"button",4),mp("click",function(){return t.openEditSprint()}),ii(8,"mat-icon"),UI(9,"edit"),Dc()(),ii(10,"button",5),mp("click",function(){return t.openNewSprint()}),ii(11,"mat-icon"),UI(12,"add"),Dc()(),eI(13,Mo,11,7,"div",6),Dc(),ii(14,"div",7)(15,"mat-button-toggle-group",8),mp("change",function(a){return t.setPriority(a.value)}),oI(16,Ro,2,2,"mat-button-toggle",3,rI),Dc(),eI(18,Lo,18,5,"div",9),eI(19,Ho,18,5,"div",10),ii(20,"mat-form-field",11)(21,"mat-label"),UI(22,"N\xB0 ticket"),Dc(),ii(23,"input",12),mp("input",function(a){return t.ticketSearch.set(a.target.value)}),Dc(),ii(24,"mat-icon",13),UI(25,"search"),Dc()(),up(26,"span",14),ii(27,"button",15),mp("click",function(){return t.openNew()}),ii(28,"mat-icon"),UI(29,"add"),Dc(),UI(30," Tarea "),Dc(),eI(31,Uo,4,0,"button",16),Dc(),ii(32,"div",17),oI(33,ta,11,8,"section",18,Po),Dc()),e&2){let i;Ry(4),lp("value",t.activeSprintId()),Ry(),iI(t.sprints()),Ry(2),lp("disabled",!t.activeSprint()),Ry(6),tI((i=t.activeSprint())?13:-1,i),Ry(2),lp("value",t.priorityFilter()),Ry(),iI(t.PRIORITY_FILTERS),Ry(2),tI(t.assigneeChips().length?18:-1),Ry(),tI(t.clientChips().length?19:-1),Ry(4),lp("value",t.ticketSearch()),Ry(8),tI(t.puedeBorrarBoard()?31:-1),Ry(2),iI(t.columns());}},dependencies:[Oi,Ri,Mi,Ii,_,I,va,ga,An,Fi,At,lt,Mi$1,nt,ua,xi$1,de,it,oe,Ot$1,nn,tn,Ft$1,Rt$1,J,Li,Lt,Ei$1,Oi$2,Ia$1,xa$1,Gi,Oe],styles:['[_nghost-%COMP%]{display:block;padding:16px;min-height:100%;box-sizing:border-box;background-color:#efeadf;background-image:linear-gradient(rgba(43,43,58,.04) 1px,transparent 1px),linear-gradient(90deg,rgba(43,43,58,.04) 1px,transparent 1px);background-size:24px 24px}.sprint-bar[_ngcontent-%COMP%]{display:flex;align-items:center;flex-wrap:wrap;gap:8px;margin-bottom:12px;padding:8px 12px;background:#ffffffbf;border:1px solid rgba(43,43,58,.08);border-radius:12px;-webkit-backdrop-filter:blur(2px);backdrop-filter:blur(2px)}.sprint-bar[_ngcontent-%COMP%]   .sprint-select[_ngcontent-%COMP%]{width:180px}.sprint-banner[_ngcontent-%COMP%]{display:flex;align-items:center;flex-wrap:wrap;gap:6px;margin-left:8px;font-size:13px;color:#2b2b3a}.sprint-banner[_ngcontent-%COMP%]   .sb-name[_ngcontent-%COMP%]{font-weight:700}.sprint-banner[_ngcontent-%COMP%]   .sb-goal[_ngcontent-%COMP%]{color:var(--mat-sys-on-surface-variant)}.sprint-banner[_ngcontent-%COMP%]   .sb-sep[_ngcontent-%COMP%]{color:var(--mat-sys-outline)}.sprint-banner[_ngcontent-%COMP%]   .sb-dates[_ngcontent-%COMP%], .sprint-banner[_ngcontent-%COMP%]   .sb-cap[_ngcontent-%COMP%]{font-size:12px;color:var(--mat-sys-on-surface-variant)}.sprint-banner[_ngcontent-%COMP%]   .sb-status[_ngcontent-%COMP%]{font-size:10px;font-weight:700;text-transform:uppercase;padding:1px 8px;border-radius:9px;color:#fff}.sprint-banner[_ngcontent-%COMP%]   .sb-status.st-active[_ngcontent-%COMP%]{background:#27ae60}.sprint-banner[_ngcontent-%COMP%]   .sb-status.st-completed[_ngcontent-%COMP%]{background:#8a8a9a}.sprint-banner[_ngcontent-%COMP%]   .sb-status.st-planned[_ngcontent-%COMP%]{background:var(--brand)}.board-toolbar[_ngcontent-%COMP%]{display:flex;align-items:center;flex-wrap:wrap;gap:12px;margin-bottom:18px;padding:10px 12px;background:#ffffffbf;border:1px solid rgba(43,43,58,.08);border-radius:12px;-webkit-backdrop-filter:blur(2px);backdrop-filter:blur(2px)}.board-toolbar[_ngcontent-%COMP%]   .spacer[_ngcontent-%COMP%]{flex:1 1 auto}.board-toolbar[_ngcontent-%COMP%]   .danger[_ngcontent-%COMP%]{color:var(--mat-sys-error)}.assignee-filter[_ngcontent-%COMP%]{display:flex;align-items:center;flex-wrap:wrap;gap:8px}.assignee-filter[_ngcontent-%COMP%]   .filter-label[_ngcontent-%COMP%]{font-size:12px;color:var(--mat-sys-on-surface-variant)}.assignee-select[_ngcontent-%COMP%]{width:200px}.assignee-chips[_ngcontent-%COMP%]{display:flex}.achip[_ngcontent-%COMP%]{font-size:11.5px;font-weight:600;color:#3a3a4a;min-height:26px}.achip[_ngcontent-%COMP%]   button[matChipRemove][_ngcontent-%COMP%]{color:#3a3a4a;opacity:.7}.achip[_ngcontent-%COMP%]   button[matChipRemove][_ngcontent-%COMP%]:hover{opacity:1}.achip[_ngcontent-%COMP%]   button[matChipRemove][_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%]{font-size:16px;width:16px;height:16px}.client-filter[_ngcontent-%COMP%]{display:flex;align-items:center;flex-wrap:wrap;gap:8px}.client-select[_ngcontent-%COMP%]{width:200px}.ticket-search[_ngcontent-%COMP%]{width:150px}.cchip[_ngcontent-%COMP%]{max-width:200px}.cchip[_ngcontent-%COMP%]     .mdc-evolution-chip__text-label{overflow:hidden;text-overflow:ellipsis}.kanban[_ngcontent-%COMP%]{display:grid;grid-template-columns:repeat(4,minmax(220px,1fr));gap:16px;align-items:start}.kanban-col[_ngcontent-%COMP%]{background:#fff6;border:1px solid rgba(43,43,58,.06);border-radius:12px;padding:10px;min-height:140px}.col-header[_ngcontent-%COMP%]{display:flex;align-items:center;gap:8px;padding:2px 4px 8px;margin-bottom:6px;border-bottom:2px solid var(--mat-sys-outline-variant)}.col-header[_ngcontent-%COMP%]   .col-title[_ngcontent-%COMP%]{font-size:13px;font-weight:800;letter-spacing:.03em;text-transform:uppercase;color:#2b2b3a}.col-header[_ngcontent-%COMP%]   .col-count[_ngcontent-%COMP%]{margin-left:auto;font-size:12px;font-weight:700;color:#2b2b3a;background:#fff;border:1px solid rgba(43,43,58,.12);border-radius:10px;padding:1px 8px}.col-header.head-todo[_ngcontent-%COMP%]{border-bottom-color:#8a8a9a}.col-header.head-in_progress[_ngcontent-%COMP%]{border-bottom-color:var(--brand)}.col-header.head-review[_ngcontent-%COMP%]{border-bottom-color:var(--accent)}.col-header.head-done[_ngcontent-%COMP%]{border-bottom-color:#27ae60}.col-dot[_ngcontent-%COMP%]{width:9px;height:9px;border-radius:50%}.col-dot.dot-todo[_ngcontent-%COMP%]{background:#8a8a9a}.col-dot.dot-in_progress[_ngcontent-%COMP%]{background:var(--brand)}.col-dot.dot-review[_ngcontent-%COMP%]{background:var(--accent)}.col-dot.dot-done[_ngcontent-%COMP%]{background:#27ae60}.col-cards[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:14px;min-height:60px;padding:4px 2px}.empty-col[_ngcontent-%COMP%]{display:flex;flex-direction:column;align-items:center;gap:4px;padding:24px 0;color:#2b2b3a59;font-size:12px}.story-card[_ngcontent-%COMP%]{--shadow: 0 4px 10px rgba(43, 43, 58, .16), 0 1px 2px rgba(43, 43, 58, .1);position:relative;padding:11px 12px 10px;border:none;border-top:3px solid var(--accent);border-radius:3px;box-shadow:var(--shadow);cursor:pointer;-webkit-user-select:none;user-select:none;transform:rotate(var(--tilt, 0deg));transition:transform .16s ease,box-shadow .16s ease}.story-card[_ngcontent-%COMP%]:hover{transform:rotate(0) translateY(-3px) scale(1.015);box-shadow:0 10px 22px #2b2b3a38,0 2px 4px #2b2b3a1f;z-index:2}.story-card.not-mine[_ngcontent-%COMP%]{cursor:default;filter:saturate(.85)}.story-card.overdue[_ngcontent-%COMP%]{box-shadow:var(--shadow),0 0 0 2px #e74c3c}.story-card.soon[_ngcontent-%COMP%]{box-shadow:var(--shadow),0 0 0 2px #f29e3b}.story-card.cdk-drag-dragging[_ngcontent-%COMP%]{transform:rotate(0);box-shadow:0 14px 30px #2b2b3a47}.card-top[_ngcontent-%COMP%]{display:flex;align-items:center;gap:8px;margin-bottom:4px}.card-top[_ngcontent-%COMP%]   .grow[_ngcontent-%COMP%]{flex:1}.card-top[_ngcontent-%COMP%]   .card-ticket[_ngcontent-%COMP%]{font-family:JetBrains Mono,monospace;font-size:12px;font-weight:700;color:#2b2b3a}.card-top[_ngcontent-%COMP%]   .del-btn[_ngcontent-%COMP%]{width:24px;height:24px;line-height:24px;color:#2b2b3a8c}.card-top[_ngcontent-%COMP%]   .del-btn[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%]{font-size:16px;width:16px;height:16px}.prio-badge[_ngcontent-%COMP%]{font-size:10px;font-weight:700;letter-spacing:.02em;text-transform:uppercase;padding:1px 7px;border-radius:9px;color:#fff}.prio-badge.prio-alta[_ngcontent-%COMP%]{background:#e74c3c}.prio-badge.prio-media[_ngcontent-%COMP%]{background:#f2811d}.prio-badge.prio-baja[_ngcontent-%COMP%]{background:#2b2b3a73}.client-name[_ngcontent-%COMP%]{display:inline-flex;align-items:center;gap:5px;font-size:11px;font-weight:700;color:#2b2b3a;margin-bottom:4px}.client-name[_ngcontent-%COMP%]:before{content:"";width:8px;height:8px;border-radius:50%;background:var(--accent)}.card-title[_ngcontent-%COMP%]{font-size:13px;line-height:1.35;color:#2b2b3a;margin-bottom:8px}.soon-badge[_ngcontent-%COMP%]{font-size:11px;font-weight:600;color:#b5560e;margin-bottom:8px}.hd-estatus[_ngcontent-%COMP%]{display:inline-block;font-size:10px;font-weight:700;letter-spacing:.02em;text-transform:uppercase;color:#2b2b3a;background:#ffffffa6;border:1px solid var(--accent);border-radius:9px;padding:1px 8px;margin-bottom:8px}.prog[_ngcontent-%COMP%]{display:flex;align-items:center;gap:8px;margin-bottom:8px}.prog[_ngcontent-%COMP%]   mat-progress-bar[_ngcontent-%COMP%]{flex:1;border-radius:4px}.prog[_ngcontent-%COMP%]   input[_ngcontent-%COMP%]{width:48px;padding:3px 5px;border:1px solid rgba(43,43,58,.2);border-radius:5px;background:#ffffffb3;color:#2b2b3a;font:inherit;font-size:12px;text-align:right}.wait-btn[_ngcontent-%COMP%]{width:100%;border:1px solid rgba(43,43,58,.18);background:#ffffff8c;color:#2b2b3a;border-radius:6px;padding:5px 8px;font-size:12px;cursor:pointer;margin-bottom:8px}.wait-btn.active[_ngcontent-%COMP%]{background:#fef5e7;border-color:#f29e3b;color:#b9770e}.wait-btn.alert[_ngcontent-%COMP%]{background:#fdedec;border-color:#e74c3c;color:#c0392b;font-weight:600;animation:_ngcontent-%COMP%_pulse 1.4s ease-in-out infinite}@keyframes _ngcontent-%COMP%_pulse{0%,to{opacity:1}50%{opacity:.55}}.card-check[_ngcontent-%COMP%]{display:flex;align-items:center;gap:4px;margin-bottom:6px;font-size:13px;color:#2b2b3a}.check-text[_ngcontent-%COMP%]{cursor:default}.card-bottom[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:space-between;margin-top:4px}.card-due[_ngcontent-%COMP%]{display:inline-flex;align-items:center;gap:3px;font-size:11px;color:#2b2b3a99}.card-due[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%]{font-size:14px;width:14px;height:14px}.card-due.overdue[_ngcontent-%COMP%]{color:#c0392b;font-weight:700}.card-due.soon[_ngcontent-%COMP%]{color:#b5560e}.avatar[_ngcontent-%COMP%]{display:inline-flex;align-items:center;justify-content:center;min-width:26px;height:22px;padding:0 8px;border-radius:11px;font-family:JetBrains Mono,monospace;font-size:10px;font-weight:700;letter-spacing:.02em;color:#fff;box-shadow:0 0 0 2px #fff9}.avatar.unassigned[_ngcontent-%COMP%]{width:26px;height:26px;padding:0;background:transparent;border:1.5px dashed rgba(43,43,58,.4);box-shadow:none}.cdk-drag-preview[_ngcontent-%COMP%]{border-radius:3px;box-shadow:0 14px 30px #2b2b3a4d}.cdk-drag-placeholder[_ngcontent-%COMP%]{opacity:.3}.col-cards.cdk-drop-list-dragging[_ngcontent-%COMP%]   .story-card[_ngcontent-%COMP%]:not(.cdk-drag-placeholder){transition:transform .2s cubic-bezier(0,0,.2,1)}@media(max-width:1024px){.kanban[_ngcontent-%COMP%]{grid-template-columns:repeat(2,1fr)}}@media(max-width:600px){.kanban[_ngcontent-%COMP%]{grid-template-columns:1fr}.client-select[_ngcontent-%COMP%]{width:100%}}']})};export{Ni as Board};