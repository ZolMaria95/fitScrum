import {i}from'./chunk-CxxKxgq5.js';import {E,B as Bn,u as ue$1,e as W,f as Wt,h as Le$1,w as we$1,j as zt,H,k as nl,l as lD,y as yn,q as qL,K as KL,m as q,O as OE,o as ur,p as Nt,s as bo,t as ii$1,i as ii$2,a as yp,W as WI,T as Tc,n as nI,v as dp,c as Oy,d as up,r as rI,x as Tp,A as wI,C as b,J as Jh,D as N,G as Ec,I as so,M as sF,P as hr,Q as w,S as Ot,U as yI,V as vI,X as OI,Z as Mp,_ as Ip,$ as II,a0 as DI,a1 as Nr,a2 as th,a3 as h,a4 as bm,a5 as np,a6 as $p,a7 as Ll,a8 as gd,a9 as Dc,aa as Dp,ab as Kf,ac as Xt,ad as _p,ae as op,af as pI,ag as Jl,g as gI,ah as Xl,R as Rp,ai as M,aj as Ne$1,ak as at,al as B,am as q$1,an as ql,ao as cn,ap as Be$1,aq as me,ar as jh,as as Ur,at as Mr,au as Hv,av as xr,aw as ee,ax as ge$1,ay as Oi$1,az as zL,aA as Vr,aB as jy,aC as tn,aD as AD,aE as Wo,aF as Bh,aG as $h,aH as hp}from'./main-RGPEFDWF.js';import {Q as Qt}from'./chunk-BqD2EqyF.js';import {b as be$1,E as Ei,O as Oi,T as Tt,Q as Qe,U}from'./chunk-7Dy3bahA.js';import {v as va,A as An}from'./chunk-BOEjxjwv.js';function pe(i){i||(i=E(Le$1));let o=new N(t=>{if(i.destroyed){t.next();return}return i.onDestroy(t.next.bind(t))});return t=>t.pipe(Jh(o))}function xt(i,o){let e=!o?.manualCleanup?o?.injector?.get(Le$1)??E(Le$1):null,n=Se(o?.equal),r;o?.requireSync?r=yn({kind:0},{equal:n}):r=yn({kind:1,value:o?.initialValue},{equal:n});let s,V=i.subscribe({next:h=>r.set({kind:1,value:h}),error:h=>{r.set({kind:2,error:h}),s?.();},complete:()=>{s?.();}});if(o?.requireSync&&r().kind===0)throw new b(601,false);return s=e?.onDestroy(V.unsubscribe.bind(V)),lD(()=>{let h=r();switch(h.kind){case 1:return h.value;case 2:throw h.error;case 0:throw new b(601,false)}},{equal:o?.equal})}function Se(i=Object.is){return (o,t)=>o.kind===1&&t.kind===1&&i(o.value,t.value)}var _e=(()=>{class i{static \u0275fac=function(e){return new(e||i)};static \u0275mod=Ec({type:i});static \u0275inj=so({imports:[sF]})}return i})();var Le=["*"],Te=`.mdc-list {
  margin: 0;
  padding: 8px 0;
