import {U as Ue,L as La,I as Ia$1,x as xa$1,M as Mr,w as wr,J as Ja,Q as Qn}from'./chunk-BDDHAvWz.js';import {u as ue,N,_ as _i,p as pi,f as fi,a as ui,v as vt,m as mi}from'./chunk-NqCM5ZT7.js';import {Q as Qt}from'./chunk-CLJhs3fW.js';import {aI as ih,D,M as Mo,l as lD,x as xE,o as oi,q as qI,a as Dc,t as tI,g as gp,c as xy,A as Ap,n as nI,d as cp,_ as _c,B as Bn$1,aJ as J,ag as fI,P as Pp,ah as Kl,Z as ZI,ai as Jl,b as Bv,aK as iI,y as lp,aN as wI,O as Op,U as Uv,aL as sI,ae as Cp,G as kE,I as _l,a3 as hh,J as qr,bu as d,aj as S,aA as zL,L as hr,bv as HL,ak as Me,au as Ir,ap as cn,X as Xn$1,ax as ee,al as ct$1,aO as nn$2,ay as Be,bw as _h,ar as ge,an as q,ao as nh,bx as ht,as as Rh,aQ as ZL,S as mI,T as yI,a7 as tD,b3 as pp,aa as ap,V as RI,Y as bp,ab as Ep,a0 as EI,a1 as II,$ as vp,a5 as Dm,ac as PE,a6 as Xf,aD as Ss,aE as qo,k as el,aV as ll,by as en$1,Q as Qh,bh as wc,bi as Tc,aX as YL,h as hI,b4 as oI,bz as It,am as B,R as w$1,bA as Qt$1,bB as np,bC as at$1,bD as rt$1,bE as ie$1,aR as Ei$1,av as Lv,e as Wt,aP as ot$1,j as Wt$1,bF as vh,i as De,bG as _,bH as xh,F as M,aB as Hr,bI as Yt,aU as Yh,aG as jh,aC as Xt,bJ as Iu,bK as Ct,bL as wt,aW as rm,bM as es,w as si,af as tp,b0 as lu,b1 as uu,aH as fp,bd as kp,b9 as P,p as Oy,b2 as io,bN as cr,bn as sD}from'./main-C4IQZGKV.js';import {F as Ft,R as Rt}from'./chunk-T2GxJfzb.js';import {d as de,i as it$1,o as oe,n as nn$1,t as tn$1,O as Ot,l as le}from'./chunk-CbEMymLo.js';import {y as yi$1,v as vi,Q as Qe,I as It$1,H,G,a as Ht,q as q$1,z as zt,B as Bt}from'./chunk-BQaPQge6.js';import {v as va,g as ga,t as ta,i as ie,X as Xn,b as bn$1,h as ht$1}from'./chunk-DePqRDB0.js';import {w}from'./chunk-C1qmADXh.js';var Ji=["*",[["mat-chip-avatar"],["","matChipAvatar",""]],[["mat-chip-trailing-icon"],["","matChipRemove",""],["","matChipTrailingIcon",""]]],en=["*","mat-chip-avatar, [matChipAvatar]","mat-chip-trailing-icon,[matChipRemove],[matChipTrailingIcon]"];function tn(a,n){a&1&&(oi(0,"span",3),yI(1,1),Dc());}function nn(a,n){a&1&&(oi(0,"span",6),yI(1,2),Dc());}var an=["*"];var on=new S("mat-chips-default-options",{providedIn:"root",factory:()=>({separatorKeyCodes:[13]})}),yi=new S("MatChipAvatar"),bi=new S("MatChipTrailingIcon"),Ci=new S("MatChipEdit"),it=new S("MatChipRemove"),wi=new S("MatChip"),Si=(()=>{class a{_elementRef=D(hr);_parentChip=D(wi);_isPrimary=true;_isLeading=false;get disabled(){return this._disabled||this._parentChip?.disabled||false}set disabled(e){this._disabled=e;}_disabled=false;tabIndex=-1;_allowFocusWhenDisabled=false;_getDisabledAttribute(){return this.disabled&&!this._allowFocusWhenDisabled?"":null}constructor(){D(q).load(nh),this._elementRef.nativeElement.nodeName==="BUTTON"&&this._elementRef.nativeElement.setAttribute("type","button");}focus(){this._elementRef.nativeElement.focus();}static \u0275fac=function(t){return new(t||a)};static \u0275dir=PE({type:a,selectors:[["","matChipContent",""]],hostAttrs:[1,"mat-mdc-chip-action","mdc-evolution-chip__action","mdc-evolution-chip__action--presentational"],hostVars:8,hostBindings:function(t,i){t&2&&(ap("disabled",i._getDisabledAttribute())("aria-disabled",i.disabled),bp("mdc-evolution-chip__action--primary",i._isPrimary)("mdc-evolution-chip__action--secondary",!i._isPrimary)("mdc-evolution-chip__action--trailing",!i._isPrimary&&!i._isLeading));},inputs:{disabled:[2,"disabled","disabled",ZL],tabIndex:[2,"tabIndex","tabIndex",e=>e==null?-1:YL(e)],_allowFocusWhenDisabled:"_allowFocusWhenDisabled"}})}return a})(),ki=(()=>{class a extends Si{_getTabindex(){return this.disabled&&!this._allowFocusWhenDisabled?null:this.tabIndex.toString()}_handleClick(e){!this.disabled&&this._isPrimary&&(e.preventDefault(),this._parentChip._handlePrimaryActionInteraction());}_handleKeydown(e){(e.keyCode===13||e.keyCode===32)&&!this.disabled&&this._isPrimary&&!this._parentChip._isEditing&&(e.preventDefault(),this._parentChip._handlePrimaryActionInteraction());}static \u0275fac=(()=>{let e;return function(i){return (e||(e=Dm(a)))(i||a)}})();static \u0275dir=PE({type:a,selectors:[["","matChipAction",""]],hostVars:3,hostBindings:function(t,i){t&1&&gp("click",function(r){return i._handleClick(r)})("keydown",function(r){return i._handleKeydown(r)}),t&2&&(ap("tabindex",i._getTabindex()),bp("mdc-evolution-chip__action--presentational",false));},features:[Xf]})}return a})();var ua=(()=>{class a extends ki{_isPrimary=false;_handleClick(e){this.disabled||(e.stopPropagation(),e.preventDefault(),this._parentChip.remove());}_handleKeydown(e){(e.keyCode===13||e.keyCode===32)&&!this.disabled&&(e.stopPropagation(),e.preventDefault(),this._parentChip.remove());}static \u0275fac=(()=>{let e;return function(i){return (e||(e=Dm(a)))(i||a)}})();static \u0275dir=PE({type:a,selectors:[["","matChipRemove",""]],hostAttrs:["role","button",1,"mat-mdc-chip-remove","mat-mdc-chip-trailing-icon","mat-focus-indicator","mdc-evolution-chip__icon","mdc-evolution-chip__icon--trailing"],hostVars:1,hostBindings:function(t,i){t&2&&ap("aria-hidden",null);},features:[tD([{provide:it,useExisting:a}]),Xf]})}return a})(),nt=(()=>{class a{_changeDetectorRef=D(zL);_elementRef=D(hr);_tagName=D(HL);_ngZone=D(Me);_focusMonitor=D(Ir);_globalRippleOptions=D(cn,{optional:true});_document=D(Xn$1);_onFocus=new ee;_onBlur=new ee;_isBasicChip=false;role=null;_hasFocusInternal=false;_pendingFocus=false;_actionChanges;_animationsDisabled=ct$1();_allLeadingIcons;_allTrailingIcons;_allEditIcons;_allRemoveIcons;_hasFocus(){return this._hasFocusInternal}id=D(nn$2).getId("mat-mdc-chip-");ariaLabel=null;ariaDescription=null;_chipListDisabled=false;_hadFocusOnRemove=false;_textElement;get value(){return this._value!==void 0?this._value:this._textElement.textContent.trim()}set value(e){this._value=e;}_value;color;removable=true;highlighted=false;disableRipple=false;get disabled(){return this._disabled||this._chipListDisabled}set disabled(e){this._disabled=e;}_disabled=false;removed=new Be;destroyed=new Be;basicChipAttrName="mat-basic-chip";leadingIcon;editIcon;trailingIcon;removeIcon;primaryAction;_rippleLoader=D(_h);_injector=D(ge);constructor(){let e=D(q);e.load(nh),e.load(ht),this._monitorFocus(),this._rippleLoader?.configureRipple(this._elementRef.nativeElement,{className:"mat-mdc-chip-ripple",disabled:this._isRippleDisabled()});}ngOnInit(){this._isBasicChip=this._elementRef.nativeElement.hasAttribute(this.basicChipAttrName)||this._tagName.toLowerCase()===this.basicChipAttrName;}ngAfterViewInit(){this._textElement=this._elementRef.nativeElement.querySelector(".mat-mdc-chip-action-label"),this._pendingFocus&&(this._pendingFocus=false,this.focus());}ngAfterContentInit(){this._actionChanges=Rh(this._allLeadingIcons.changes,this._allTrailingIcons.changes,this._allEditIcons.changes,this._allRemoveIcons.changes).subscribe(()=>this._changeDetectorRef.markForCheck());}ngDoCheck(){this._rippleLoader.setDisabled(this._elementRef.nativeElement,this._isRippleDisabled());}ngOnDestroy(){this._focusMonitor.stopMonitoring(this._elementRef),this._rippleLoader?.destroyRipple(this._elementRef.nativeElement),this._actionChanges?.unsubscribe(),this.destroyed.emit({chip:this}),this.destroyed.complete();}remove(){this.removable&&(this._hadFocusOnRemove=this._hasFocus(),this.removed.emit({chip:this}));}_isRippleDisabled(){return this.disabled||this.disableRipple||this._animationsDisabled||this._isBasicChip||!this._hasInteractiveActions()||!!this._globalRippleOptions?.disabled}_hasTrailingIcon(){return !!(this.trailingIcon||this.removeIcon)}_handleKeydown(e){(e.keyCode===8&&!e.repeat||e.keyCode===46)&&(e.preventDefault(),this.remove());}focus(){this.disabled||(this.primaryAction?this.primaryAction.focus():this._pendingFocus=true);}_getSourceAction(e){return this._getActions().find(t=>{let i=t._elementRef.nativeElement;return i===e||i.contains(e)})}_getActions(){let e=[];return this.editIcon&&e.push(this.editIcon),this.primaryAction&&e.push(this.primaryAction),this.removeIcon&&e.push(this.removeIcon),e}_handlePrimaryActionInteraction(){}_hasInteractiveActions(){return this._getActions().length>0}_edit(e){}_monitorFocus(){this._focusMonitor.monitor(this._elementRef,true).subscribe(e=>{let t=e!==null;t!==this._hasFocusInternal&&(this._hasFocusInternal=t,t?this._onFocus.next({chip:this}):(this._changeDetectorRef.markForCheck(),setTimeout(()=>this._ngZone.run(()=>this._onBlur.next({chip:this})))));});}static \u0275fac=function(t){return new(t||a)};static \u0275cmp=xE({type:a,selectors:[["mat-basic-chip"],["","mat-basic-chip",""],["mat-chip"],["","mat-chip",""]],contentQueries:function(t,i,o){if(t&1&&vp(o,yi,5)(o,Ci,5)(o,bi,5)(o,it,5)(o,yi,5)(o,bi,5)(o,Ci,5)(o,it,5),t&2){let r;EI(r=II())&&(i.leadingIcon=r.first),EI(r=II())&&(i.editIcon=r.first),EI(r=II())&&(i.trailingIcon=r.first),EI(r=II())&&(i.removeIcon=r.first),EI(r=II())&&(i._allLeadingIcons=r),EI(r=II())&&(i._allTrailingIcons=r),EI(r=II())&&(i._allEditIcons=r),EI(r=II())&&(i._allRemoveIcons=r);}},viewQuery:function(t,i){if(t&1&&Ep(ki,5),t&2){let o;EI(o=II())&&(i.primaryAction=o.first);}},hostAttrs:[1,"mat-mdc-chip"],hostVars:31,hostBindings:function(t,i){t&1&&gp("keydown",function(r){return i._handleKeydown(r)}),t&2&&(pp("id",i.id),ap("role",i.role)("aria-label",i.ariaLabel),RI("mat-"+(i.color||"primary")),bp("mdc-evolution-chip",!i._isBasicChip)("mdc-evolution-chip--disabled",i.disabled)("mdc-evolution-chip--with-trailing-action",i._hasTrailingIcon())("mdc-evolution-chip--with-primary-graphic",i.leadingIcon)("mdc-evolution-chip--with-primary-icon",i.leadingIcon)("mdc-evolution-chip--with-avatar",i.leadingIcon)("mat-mdc-chip-with-avatar",i.leadingIcon)("mat-mdc-chip-highlighted",i.highlighted)("mat-mdc-chip-disabled",i.disabled)("mat-mdc-basic-chip",i._isBasicChip)("mat-mdc-standard-chip",!i._isBasicChip)("mat-mdc-chip-with-trailing-icon",i._hasTrailingIcon())("_mat-animation-noopable",i._animationsDisabled));},inputs:{role:"role",id:"id",ariaLabel:[0,"aria-label","ariaLabel"],ariaDescription:[0,"aria-description","ariaDescription"],value:"value",color:"color",removable:[2,"removable","removable",ZL],highlighted:[2,"highlighted","highlighted",ZL],disableRipple:[2,"disableRipple","disableRipple",ZL],disabled:[2,"disabled","disabled",ZL]},outputs:{removed:"removed",destroyed:"destroyed"},exportAs:["matChip"],features:[tD([{provide:wi,useExisting:a}])],ngContentSelectors:en,decls:8,vars:2,consts:[[1,"mat-mdc-chip-focus-overlay"],[1,"mdc-evolution-chip__cell","mdc-evolution-chip__cell--primary"],["matChipContent",""],[1,"mdc-evolution-chip__graphic","mat-mdc-chip-graphic"],[1,"mdc-evolution-chip__text-label","mat-mdc-chip-action-label"],[1,"mat-mdc-chip-primary-focus-indicator","mat-focus-indicator"],[1,"mdc-evolution-chip__cell","mdc-evolution-chip__cell--trailing"]],template:function(t,i){t&1&&(mI(Ji),lp(0,"span",0),oi(1,"span",1)(2,"span",2),tI(3,tn,2,0,"span",3),oi(4,"span",4),yI(5),lp(6,"span",5),Dc()()(),tI(7,nn,2,0,"span",6)),t&2&&(xy(3),nI(i.leadingIcon?3:-1),xy(4),nI(i._hasTrailingIcon()?7:-1));},dependencies:[Si],styles:[`.mdc-evolution-chip,
